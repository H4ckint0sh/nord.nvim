...
function bufferline.highlights()
  ...
  return {
    ...
    BufferCurrentTarget = vim.tbl_extend(
      "force",
      { bg = c.polar_night.brighter, fg = c.aurora.red, bold = false },
      config.current
    ),
    ...
    BufferVisibleTarget = { bg = c.polar_night.bright, fg = c.aurora.red, bold = false },
    ...
    BufferInactiveTarget = { bg = global_bg, fg = c.aurora.red, bold = false },
...
function bufferline.akinsho()
  ...
  return {
    ...
    pick = { bg = global_bg, bold = false, italic = false },
    ...
    pick_selected = vim.tbl_extend("force", current_hi, { bold = false }),
    ...
    pick_visible = { bg = c.polar_night.bright, bold = false, italic = false },
