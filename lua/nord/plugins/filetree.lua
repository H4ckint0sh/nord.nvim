...
function filetree.highlights()
  ...
  return {
    ...
    NvimTreeRootFolder = { fg = c.snow_storm.origin, bold = false },
    ...
    NeoTreeRootName = { fg = c.snow_storm.origin, bold = false },
    NeoTreeSymbolicLinkTarget = { fg = c.frost.artic_water },
    NeoTreeTabActive = { fg = c.snow_storm.origin, bg = c.polar_night.brighter, bold = false },
